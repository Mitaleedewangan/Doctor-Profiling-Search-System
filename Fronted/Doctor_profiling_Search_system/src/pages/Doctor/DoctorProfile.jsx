...
// //     return(
// //         <div className="bg-white p-6 rounded-lg shadow-lg w-full md:w-2/3 mx-auto">

// //         <div className="flex items-center gap-6" >
// //             <img src="/assets/doctorimg.jpg" alt=""  className="w-32 h-32 rounded-full object-cover"/>
// //             <div>
...
// //                 <p className=" text-sm text-gray-600">{doctor.startTime} - {doctor.endTime}</p>
                
// //             </div>

// //         </div>
// //         <button onClick={()=>alert("Book Appointment")} className="mt-6 px-5 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
// //             Book Appointment
// //         </button>
// //         </div>
// //     )
...
//     fetch(`http://localhost:5000/api/doctors/profile/${id}`, {
//       headers: {
...
//   if (!doctor) return <p className="text-center mt-6">Doctor not found.</p>;
...
//       <button
//         onClick={() => alert("Book Appointment")}
